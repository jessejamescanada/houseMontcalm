...
const Services = () => {
  return (
    <div
      ...
      id='services'
    >
      <div className='relative w-full h-[20rem] mb-3 sm:mb-0 '>
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <h2 className='text-zinc-500 text-4xl md:text-[2.5rem] text-center  font-serif sm:m-0 sm:text-5xl sm:w-[300px]'>
